...
import { getChain } from '@moonup/moon-types';
...
const ETHOS_ABI = [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract ICollateralConfig', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_collateralDrawn', type: 'uint256' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract IRedemptionHelper', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
