...
export class MoonSDK extends EventEmitter implements IMoonSDK {
	...
	/**
	 * Retrieves the Financial Datasets SDK instance from the Moon API service.
	 * @returns {MoonAPI.FinancialDatasets} The Financial Datasets SDK instance.
	 */
	getFinancialDatasetsSDK(): MoonAPI.FinancialDatasets {
