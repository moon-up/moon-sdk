...
export type DataGetUserDebankTotalBalanceData = DebankPortfolioAPIResponse;

export interface DataGetUserDebankTotalBalanceParams {
	address: string;
	refresh?: boolean;
}
...
export type OdosAssembleLimitOrderData =
	OdosAPIResponseOdosExecuteFunctionResult;

/** - The body containing the limit order parameters. */
export interface OdosAssembleLimitOrderPayload {
	permit2: boolean;
	chainId: string;
	/** @format double */
	expiry: number;
...
export type OdosCancelLimitOrderData = OdosAPIResponseOdosExecuteFunctionResult;

export interface OdosCancelLimitOrderParams {
...
export type OdosCreateLimitOrderData = OdosAPIResponseOdosExecuteFunctionResult;

/** - The body containing the limit order parameters. */
export interface OdosCreateLimitOrderPayload {
	permit2: boolean;
...
export type OdosGetLimitOrdersData = OdosAPIResponseOdosExecuteFunctionResult;

export interface OdosGetLimitOrdersParams {
...
export type OdosLoginData = OdosAPIResponseOdosExecuteFunctionResult;

export interface OdosLoginParams {
...
export type TweetReplyTestData = string;

export type TweetReplyTestPayload = string;
